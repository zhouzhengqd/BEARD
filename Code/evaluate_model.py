...
def main_train():
    ...
    parser.add_argument('--load_file', type=str,default='/home/node/BACON/Code/evaluation/model_pool/BACON/BACON_ConvNet_CIFAR10_1_None.pth', help='Path to the data file')
