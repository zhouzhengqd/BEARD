...
def main():
    ...
    parser.add_argument('--data_file', type=str,default='/home/node/BACON/Code/checkpoints/CIFAR10/IPC50/Visulization/res_BACON_CIFAR10_ConvNet_50ipc.pt', help='Path to the data file')
